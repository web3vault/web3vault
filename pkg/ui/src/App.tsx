...
function App() {
  ...
  const styling = {
    background: "linear-gradient(90deg, rgba(100,76,143,0.6) 0%, rgba(52,41,81,0.6) 87%, rgba(6,38,43,0.6) 100%)",
  ...
  const SyncIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={15} height={15} fill="black" >
  ...
  const VaultIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={20} height={15} fill="white" >
  ...
  return (
    <>
      ...
      <div className="grid grid-flow-col gap-6">
        <div className="col-span-3" style={sidebarStyling}>
          {data && data.entries
